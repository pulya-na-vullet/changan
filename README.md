...
Приложение `com.changanhub.pl1_1_8` ставится из Hub, раздел **Наши приложения**.
Старые `pl1_1_7` / `pl1_1_6` / `playload` / `playrise` / `lamoreplayer` Feiyu не удаляет: Hub ставит новый id и отключает leftover.
