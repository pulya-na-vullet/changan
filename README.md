...
Приложение `com.changanhub.qb1_3_18` держит поверх всех Activity узкую колонку
справа:
...
ставится новым id `com.changanhub.qb1_3_18`; старые `quickbar` / `quickdock` /
`quicklane` / `quickkeep` / `quickrise` / `quickstash` / `quickload` / `qb1_3_15` / `qb1_3_16` / `qb1_3_17` остаются на ГУ, Hub их отключает (`pm disable-user` +
...
панель — после этого «Установить и запустить» ставит `qb1_3_18`. Сброс ГУ до
