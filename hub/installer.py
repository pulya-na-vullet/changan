...
def install_apk(
    ...
    if not _ok_install(result) and "update_incompatible" in blob.lower():
        ...
        if keep_conflict and conflict and package and conflict == package:
            ...
            step(
                ...
                "Старую панель отключаю. Рабочая QuickBar — com.changanhub.qb1_3_19.",
                72,
            )
            if conflict:
    ...
    if "no_certificates" in blob or "smimecapability" in blob:
        step(
            ...
            "в списке com.changanhub.qb1_3_19 не появится.",
            100,
        )
        return report
...
def apk_package_name(apk: Path) -> str | None:
    ...
    stem = apk.name.lower()
    if any(token in stem for token in ("quickbar", "quickdock", "quicklane", "quickkeep", "quickrise", "quickstash", "quickload", "qb1_3_15", "qb1_3_16", "qb1_3_17", "qb1_3_18", "qb1_3_19")):
        return "com.changanhub.qb1_3_19"
