...
class HubApp:
    ...
    def _page_overlay(self) -> ttk.Frame:
        ...
        body = (
            ...
            "Логотип IT•m сверху. Кнопки — иконки: свернуть, сетка, список, обновление, флешка. "
            "Свёрнутый край шире в 2 раза и из трёх зон: сетка, полное меню, 3 последних приложения. "
            ...
            "Иконки в штатном меню Feiyu не будет. После установки: IT-m · "
