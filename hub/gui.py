    ...
    def _page_player(self) -> ttk.Frame:
        ...
        ttk.Label(
            ...
            text=(
                ...
                "Пакет: com.changanhub.pl1_1_8. Старые pl1_1_7 / pl1_1_6 / playload / playrise / lamoreplayer Feiyu не удаляет — "
    ...
    def _page_apps(self) -> ttk.Frame:
        ...
        ttk.Label(
            ...
            text=(
                ...
                "Плеер: 1.1.8 · com.changanhub.pl1_1_8. Чат: 1.0.6 · com.changanhub.ch1_0_6. "
