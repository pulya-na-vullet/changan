...
class HubApp:
    ...
    def _page_ours(self) -> ttk.Frame:
        ...
        self.overlay_install_btn = card(
            ...
            f"в ZIP: 1.3.17 · {OVERLAY_PACKAGE}",
            self.overlay_hu_ver,
            self.deploy_overlay,
            self.resume_overlay,
        )
    ...
    def _page_overlay(self) -> ttk.Frame:
        ...
        body = (
            ...
            "«Установить и запустить» пишет автозапуск ACC. Рабочая — com.changanhub.qb1_3_17. "
    ...
    def _page_player(self) -> ttk.Frame:
        ...
        ttk.Label(
            ...
            text=(
                ...
                "Hub ставит новый id, как QuickBar → qb1_3_17. Без Google Play и без Compose. "
    ...
    def _page_apps(self) -> ttk.Frame:
        ...
        ttk.Label(
            page,
            text=(
                "Рабочая панель: QuickBar 1.3.17 · com.changanhub.qb1_3_17. "
