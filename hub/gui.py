...
class HubApp:
    ...
    def _page_player(self) -> ttk.Frame:
        ...
        ttk.Label(
            page,
            text=(
                "Lamore Player 1.1.1 читает USB в ГУ (не флешку ноутбука). "
                "Шрифты ×2, поля 8%/10% — системные кнопки не накрывают вкладки. "
    ...
    def _page_aichat(self) -> ttk.Frame:
        ...
        ttk.Label(
            page,
            text=(
                "AI Chat 1.0.2 ходит в интернет с ГУ (SIM/Wi‑Fi), без Google Play. "
