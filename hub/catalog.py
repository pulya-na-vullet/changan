...
CATALOG: list[CatalogApp] = [
    CatalogApp(
        id="quickbar",
        name="QuickBar 1.3.15 (правая панель)",
        summary="Всегда поверх всех окон, справа, быстрый запуск установленных приложений.",
        package="com.changanhub.qb1_3_15",
        kind="dock",
        source="bundled",
        notes="Ставится из «Наши приложения». В списке ГУ: QuickBar 1.3.15 · com.changanhub.qb1_3_15. Скрытие, сортировка и свайп «спрятать от дилера» — в зелёной колонке справа. USB или память ГУ: ключ подписывает APK v1+v2 серийником Feiyu (как Hub), зелёная кнопка ставит. Корень флешки тоже читается. Свёрнутые кнопки ×2.5. Сторонние приложения — кнопка «окно» (freeform, если ГУ умеет). Старые quickbar / quickdock / quicklane / quickkeep / quickrise / quickstash / quickload Feiyu не удаляет (auth) — это не новая панель.",
    ),
    CatalogApp(
        id="player",
        name="Lamore Player 1.1.3",
        summary="Музыка и видео с флешки ГУ: вкладки, EQ, визуализации, субтитры.",
        package="com.changanhub.pl1_1_3",
        kind="media",
        source="bundled",
        notes="Ставится из «Наши приложения». Пакет com.changanhub.pl1_1_3 (старые playload / playrise / lamoreplayer Feiyu не удаляет). Шрифты ×2. Читает USB ГУ включая корень флешки (не флешку ноутбука). Вкладки музыка/видео/эквалайзер/визуализация. Форматы Feiyu: MP3/AAC/FLAC/WAV/OGG/OPUS, MP4/MKV/WebM/MOV/TS и др.",
    ),
    CatalogApp(
        id="aichat",
        name="AI Chat 1.0.5",
