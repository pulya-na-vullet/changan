...
CATALOG: list[CatalogApp] = [
    CatalogApp(
        ...
        kind="dock",
        source="bundled",
        notes="Ставится одной кнопкой из раздела «Панель». В списке ГУ: QuickBar · com.changanhub.quicklane. Старые com.changanhub.quickbar / quickdock Feiyu не удаляет (auth).",
    ),
    CatalogApp(
        id="files",
        name="Material Files",
