...
CATALOG: list[CatalogApp] = [
    CatalogApp(
        ...
        kind="dock",
        source="bundled",
        notes="Ставится из «Наши приложения». В списке ГУ: QuickBar · com.changanhub.quickload. Скрытие, сортировка и свайп «спрятать от дилера» — в зелёной колонке справа. USB или память ГУ: ключ подписывает APK v1+v2 серийником Feiyu (как Hub), зелёная кнопка ставит. Корень флешки тоже читается. Свёрнутые кнопки ×2.5. Сторонние приложения — кнопка «окно» (freeform, если ГУ умеет). Старые quickbar / quickdock / quicklane / quickkeep / quickrise / quickstash Feiyu не удаляет (auth) — это не новая панель.",
    ),
    CatalogApp(
        id="player",
        name="Lamore Player",
        ...
        kind="media",
        source="bundled",
        notes="Ставится из «Наши приложения». Пакет com.changanhub.playload (старые playrise / lamoreplayer Feiyu не удаляет). Шрифты ×2. Читает USB ГУ включая корень флешки (не флешку ноутбука). Вкладки музыка/видео/эквалайзер/визуализация. Форматы Feiyu: MP3/AAC/FLAC/WAV/OGG/OPUS, MP4/MKV/WebM/MOV/TS и др.",
    ),
    CatalogApp(
        id="aichat",
        name="AI Chat",
        summary="Чат с DeepSeek и YandexGPT, автоозвучка ответов.",
        package="com.changanhub.chatload",
        kind="chat",
        source="bundled",
        notes="Ставится из «Наши приложения». Пакет com.changanhub.chatload. Шрифты ×2. Интернет на ГУ. Ключи в Настройках. Озвучка — RHVoice (Елена) внутри APK, не системный TTS. На Feiyu нет Google STT — пишите текстом (Яндекс-клавиатура). Русский UI из приложения, не из языка системы. Старые chatrise / aichat Feiyu не удаляет.",
    ),
    CatalogApp(
        id="files",
        name="Material Files",
